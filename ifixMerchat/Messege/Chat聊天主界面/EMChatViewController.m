...
//    [self.navView.centerButton setTitle:@"聊天" forState:UIControlStateNormal];
    //导航栏
//    self.navigationController.navigationBar.hidden = NO;
//    self.navigationController.navigationBar.barTintColor = appWhiteColor;
...
//    self.view.backgroundColor = appbgColor;
    ...
    [self.navView.leftButton setImage:backArrowIcon forState:UIControlStateNormal];
    //头像
//    NSString *nickname = [[DuoduoDB getObjectById:self.conversationModel.name fromTable:userTable] objectForKey:@"nickname"];
//    [self.navView.centerButton setTitle:nickname forState:UIControlStateNormal];
}
...
//    [self _setupNavigationBarRightItem];
    ...
    _skillView = [[UIView alloc] initWithFrame:CGRectMake(0, NavHeight, ksWidth, 0)];
    [self.view addSubview:_skillView];
    _skillView.backgroundColor = appWhiteColor;
    ...
    [self.tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_skillView.mas_bottom);
        make.left.equalTo(self.view);
        make.right.equalTo(self.view);
...
- (void)_setupNavigationBarTitle
{
    ...
    //头像
//    self.titleLabel.text = [[DuoduoDB getObjectById:self.conversationModel.name fromTable:userTable] objectForKey:@"nickname"];
...
- (void)chatBarDidCallAction
{
    NSDictionary *dic = @{
        ...
        @"key5":@"icon",
        @"key6":@"icon",
        @"key7":@"iconiconiconiconiconiconiconiconiconiconiconiconiconiconiconiconiconiconicon",
    };

    
    EMFileMessageBody *body = [[EMFileMessageBody alloc] initWithData:[dic mj_JSONData] displayName:[dic mj_JSONString]];
...
- (void)keyBoardWillShow:(NSNotification *)note
{
    ...
    void (^animation)(void) = ^void(void) {
        [self.chatBar mas_updateConstraints:^(MASConstraintMaker *make) {
            make.bottom.equalTo(self.view).offset(EMVIEWBOTTOMMARGIN -keyBoardHeight );
        }];
    };
                    ...
                    isUpload:(BOOL)aIsUpload
{
    ...
    aExt = @{
             @"nickname":@"小虎",
             @"avatar":@"http://file.giggsgame.com/image/20190902180013637"
             };
