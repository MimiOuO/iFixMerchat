...
- (void)handlePushChatController:(NSNotification *)aNotif
{
    ...
    if ([object isKindOfClass:[NSString class]]) {
        ...
        NSString *contact = [NSString stringWithFormat:@"%@",(NSNumber *)object];
        model = [EMConversationHelper modelFromContact:contact];
...
//            return (UINavigationController *)rootViewController;
            ...
            UITabBarController *tabarController = rootViewController;
            ...
            if ([selectedNV isKindOfClass:[UINavigationController class]]) {
                [selectedNV pushViewController:controller animated:YES];
//                return selectedNV;
            }
        }
...
//            (UITabBarController *)rootViewController.controllers
//
//            UINavigationController *nav = (UINavigationController *)rootViewController;
//            [nav pushViewController:controller animated:YES];
//        }
