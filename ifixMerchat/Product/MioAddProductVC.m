...
@interface MioAddProductVC ()<HXPhotoViewControllerDelegate,HXPhotoViewDelegate,UITableViewDelegate,UITableViewDataSource,STPickerAreaDelegate>
...
@implementation MioAddProductVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navView.leftButton setImage:backArrowIcon forState:UIControlStateNormal];
    [self.navView.centerButton setTitle:@"添加商品" forState:UIControlStateNormal];
